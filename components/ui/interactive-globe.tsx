...
const DEFAULT_CONNECTIONS: { from: [number, number]; to: [number, number] }[] =
  [
    ...
    { from: [28.61, 77.21], to: [24.86, 67.01] },
    { from: [51.51, -0.13], to: [24.86, 67.01] },
  ];
...
export function InteractiveGlobe({
  ...
  arcColor = "rgba(38, 102, 127, 0.5)",
  markerColor = "rgba(18, 65, 112, 1)",
  ...
  const draw = useCallback(() => {
    ...
    glowGrad.addColorStop(0, "rgba(103, 192, 144, 0.05)");
    glowGrad.addColorStop(1, "rgba(103, 192, 144, 0)");
    ...
    ctx.strokeStyle = "rgba(38, 102, 127, 0.15)";
    ctx.lineWidth = 1;
    ctx.stroke();
    ...
    for (const marker of markers) {
      ...
      if (marker.label) {
        ...
        ctx.fillStyle = "rgba(38, 102, 127, 0.7)";
